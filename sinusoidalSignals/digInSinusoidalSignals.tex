...
\item Period is measured on the x-axis as the length of one full cycle of the sinusoidal signal. For signal shown in Figure \ref{sinusoid}, this value is $period=T$. In Figure \ref{sinF1F2}, sinusoidal signals of two different frequencies are given. 
