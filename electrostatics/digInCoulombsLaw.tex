...
Principle of superposition states that in linear systems we can calculate individually contributions of forces from different charges, then add them all up to get the total force on a charge.

If we have fhree, or more charges, the total force from two charges to one charge is equal to the vector sum of the forces due to individual charges, see Figure \ref{UnitCh}. 
